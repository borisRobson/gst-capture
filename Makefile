...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Fri Aug 19 14:47:11 2016
# Project:  gst-capture.pro
# Template: app
# Command: /usr/local/QtEmbedded-4.7.2-arm/bin/qmake -spec /usr/local/QtEmbedded-4.7.2-arm/mkspecs/qws/linux-mxc-g++ CONFIG+=debug -o Makefile gst-capture.pro
#############################################################################
...
Makefile: gst-capture.pro  /usr/local/QtEmbedded-4.7.2-arm/mkspecs/qws/linux-mxc-g++/qmake.conf /usr/local/QtEmbedded-4.7.2-arm/mkspecs/common/g++.conf \
		/usr/local/QtEmbedded-4.7.2-arm/mkspecs/common/unix.conf \
		/usr/local/QtEmbedded-4.7.2-arm/mkspecs/common/linux.conf \
		/usr/local/QtEmbedded-4.7.2-arm/mkspecs/common/qws.conf \
		/usr/local/QtEmbedded-4.7.2-arm/mkspecs/qconfig.pri \
	...
	$(QMAKE) -spec /usr/local/QtEmbedded-4.7.2-arm/mkspecs/qws/linux-mxc-g++ CONFIG+=debug -o Makefile gst-capture.pro
